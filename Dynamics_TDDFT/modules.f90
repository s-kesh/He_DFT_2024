...
Type, Public  :: info_printout
  ...
  Real      (Kind=8) :: r2(3), cm(3), ang(3),Vcom_arr(3), dtps, Ekin, Elj, Ecor, auxn4
...
module coalescence
!
character (len=60)                :: filedenin_coales_1, filedenin_coales_2 ! densities file for the coalescence
character (len=60)                :: file_density_input_frozen !!! To read the density from the input  (normal statics ) file
Logical :: ldroplet_frozen=.false. ! To keep frozen the droplet when it is true
